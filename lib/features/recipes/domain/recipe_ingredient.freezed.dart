...
mixin _$RecipeIngredient {
 ...
 String get id;@JsonKey(name: 'recipe_id') String get recipeId; String get name;/// Free-form amount text (e.g. "200 g"); null when unspecified.
 String? get amount;@JsonKey(name: 'sort_order') int get sortOrder;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,recipeId,name,amount,sortOrder);

@override
String toString() {
  return 'RecipeIngredient(id: $id, recipeId: $recipeId, name: $name, amount: $amount, sortOrder: $sortOrder)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'recipe_id') String recipeId, String name, String? amount,@JsonKey(name: 'sort_order') int sortOrder
});
...
/// Create a copy of RecipeIngredient
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? recipeId = null,Object? name = null,Object? amount = freezed,Object? sortOrder = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'recipe_id')  String recipeId,  String name,  String? amount, @JsonKey(name: 'sort_order')  int sortOrder)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RecipeIngredient() when $default != null:
return $default(_that.id,_that.recipeId,_that.name,_that.amount,_that.sortOrder);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'recipe_id')  String recipeId,  String name,  String? amount, @JsonKey(name: 'sort_order')  int sortOrder)  $default,) {final _that = this;
switch (_that) {
case _RecipeIngredient():
return $default(_that.id,_that.recipeId,_that.name,_that.amount,_that.sortOrder);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'recipe_id')  String recipeId,  String name,  String? amount, @JsonKey(name: 'sort_order')  int sortOrder)?  $default,) {final _that = this;
switch (_that) {
case _RecipeIngredient() when $default != null:
return $default(_that.id,_that.recipeId,_that.name,_that.amount,_that.sortOrder);case _:
  return null;
...
class _RecipeIngredient implements RecipeIngredient {
  const _RecipeIngredient({required this.id, @JsonKey(name: 'recipe_id') required this.recipeId, required this.name, this.amount, @JsonKey(name: 'sort_order') this.sortOrder = 0});
...
/// Create a copy of RecipeIngredient
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? recipeId = null,Object? name = null,Object? amount = freezed,Object? sortOrder = null,}) {
