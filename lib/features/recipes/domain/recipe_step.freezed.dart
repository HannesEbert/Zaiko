...
mixin _$RecipeStep {
 ...
 String get text;/// Timer duration in seconds, or null when the step has no timer.
@JsonKey(name: 'timer_seconds') int? get timerSeconds;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RecipeStep&&(identical(other.text, text) || other.text == text)&&(identical(other.timerSeconds, timerSeconds) || other.timerSeconds == timerSeconds));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,text,timerSeconds);

@override
String toString() {
  return 'RecipeStep(text: $text, timerSeconds: $timerSeconds)';
}
...
@useResult
$Res call({
 String text,@JsonKey(name: 'timer_seconds') int? timerSeconds
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String text, @JsonKey(name: 'timer_seconds')  int? timerSeconds)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RecipeStep() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String text, @JsonKey(name: 'timer_seconds')  int? timerSeconds)  $default,) {final _that = this;
switch (_that) {
case _RecipeStep():
return $default(_that.text,_that.timerSeconds);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String text, @JsonKey(name: 'timer_seconds')  int? timerSeconds)?  $default,) {final _that = this;
switch (_that) {
case _RecipeStep() when $default != null:
return $default(_that.text,_that.timerSeconds);case _:
  return null;
...
class _RecipeStep implements RecipeStep {
  const _RecipeStep({required this.text, @JsonKey(name: 'timer_seconds') this.timerSeconds});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RecipeStep&&(identical(other.text, text) || other.text == text)&&(identical(other.timerSeconds, timerSeconds) || other.timerSeconds == timerSeconds));
}
